...
namespace lab3_stepanova
{
    public partial class Form1 : Form
    {
        ...
        private void editRule_ValueChanged_1(object sender, EventArgs e)
        {
            initializerule(Convert.ToString((int)editRule.Value, 2)); //переводим значение в двоичную СС
        }
